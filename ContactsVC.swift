...
class ContactsVC: UIViewController, UITableViewDataSource, UITableViewDelegate, MFMailComposeViewControllerDelegate {
    ...
    var contactsMenuItems:[String] = ["www.facebook.com/FitnessClubapp","@FitnessClubapp","www.loFitnessClub.com","support@loFitnessClub.com"];
    ...
    func tableView(tableView: UITableView, didSelectRowAtIndexPath indexPath: NSIndexPath) {
        ...
        case 0:
            ...
            if (UIApplication.sharedApplication().canOpenURL(facebookUrl!)) {
                ...
                UIApplication.sharedApplication().openURL(NSURL(string:"https://facebook.com/FitnessClubapp")!)
            }
            
            break;
            
        case 1:
            let twitterUrl = NSURL(string: "twitter:///user?screen_name=FitnessClubapp")
            if (UIApplication.sharedApplication().canOpenURL(twitterUrl!)) {
                UIApplication.sharedApplication().openURL(twitterUrl!)
            } else {
                UIApplication.sharedApplication().openURL(NSURL(string:"https://twitter.com/FitnessClubapp")!)
            }
        ...
        case 2:
            ...
            UIApplication.sharedApplication().openURL(NSURL(string:"http://www.loFitnessClub.com")!)
    ...
    func configureMailViewController() -> MFMailComposeViewController{
        ...
        mailComposerVC.setToRecipients(["support@loFitnessClub.com"])
        mailComposerVC.setSubject("FitnessClub Support")
